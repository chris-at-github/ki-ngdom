...
return [
	'ctrl' => [
		'title' => 'LLL:EXT:ai/Resources/Private/Language/locallang_tca.xlf:tx_ai_domain_model_gamemaplocation',
		'label' => 'region',
		'tstamp' => 'tstamp',
		'crdate' => 'crdate',
		'cruser_id' => 'cruser_id',
	...
	'columns' => [
		...
		'l10n_parent' => [
			...
			'config' => [
				...
				'foreign_table_where' => 'AND {#tx_ai_domain_model_gamemaplocation}.{#pid}=###CURRENT_PID### AND {#tx_ai_domain_model_gamemaplocation}.{#sys_language_uid} IN (-1,0)',
			],
		],
		'l10n_diffsource' => [
			'config' => [
